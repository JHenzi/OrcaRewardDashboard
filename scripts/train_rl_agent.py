...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Path to training episodes file (default: training_data/episodes.pkl in project root)"
    )
    parser.add_argument(
        "--epochs",
        type=int,
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Directory for checkpoints (default: models/rl_agent in project root)"
    )
    parser.add_argument(
        "--device",
        type=str,
    ...
    parser.add_argument(
        ...
        type=float,
        default=1.0,
        help="Coefficient for 1h auxiliary loss (default: 1.0, increased significantly to prevent collapse)"
    )
    parser.add_argument(
        "--aux-24h-coef",
        type=float,
